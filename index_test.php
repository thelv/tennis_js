<html>
	<head>
		...
		<style>
			...
			.teaching_block {position:absolute; background:#fff; border:1px solid #aaa; border-radius:7px; padding:10px; color:#000;line-height:20px}
	...
	<body>		
		...
		<div id=lobby>	
			...
			<div id=left_lists>
				<div id=free_players>
					...
					<div class=teaching_block style='left:12px;margin-top:2px'>
						...
						<a style='float:right;'><b>далее</b></a>
					</div>
				</div>
				<div>					
		...
		<div id=page_game>
			<div id=center>
				<div id=wait>
					<div class=teaching_block style='bottom:50%;margin-bottom:35px;width:300px'>
				...
				<div id=help>		
						<div style='position:relative; height:0; display:flex; align-items:center; justify-content: center; top:0'>						
							<div class=teaching_block style='bottom:0;margin-bottom:15px;z-index:999'>
								<svg height="11" width="20" style='margin-bottom:-11px;right:50%;position:absolute;bottom:0;'>
									<polygon points="0,1 8,11 16,1" style="fill:#fff;stroke:#aaa;stroke-width:1" />
									<polygon points="0,0 8,10 16,0" style="fill:#fff;stroke:#fff;stroke-width:1" />
									Sorry, your browser does not support inline SVG.
								...
								<p style='text-align:center; margin:0;padding-bottom:3px'><a><b>прочитал</b></a></p>
							</div>													
						</div>						 
					<b>Управление</b>: клавишы W, S, A, D - движение, стрелки влево и вправо - поворот.<br>
