		...
		eval: function(t)
		{
			...
			do
			{
				...
				{											
					...
					/*var cos=Math.cos(-player.a+Math.PI/2);
					var sin=Math.sin(-player.a+Math.PI/2)
					movingY=player.movingX*sin-player.movingY*cos;
					movingX=-player.movingX*cos-player.movingY*sin;*/
